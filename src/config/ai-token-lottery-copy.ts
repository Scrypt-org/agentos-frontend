...
const en: LotteryCopy = {
  ...
  subtitle: 'New INJ Pass wallets get one guaranteed reward.',
  pull: 'PULL TO CLAIM',
  ...
  states: {
    ...
    wallet_unavailable: 'Sign in with an INJ Pass wallet to check eligibility.',
...
export const LOTTERY_COPY: Record<LotteryLanguage, LotteryCopy> = {
  ...
  fr: {
    ...
    subtitle: 'Chaque nouveau portefeuille INJ Pass reçoit une récompense garantie.',
    ...
    states: {
      ...
      wallet_unavailable: 'Connectez-vous avec un portefeuille INJ Pass.',
  ...
  ko: {
    ...
    subtitle: '새 INJ Pass 지갑은 보상을 한 번 확정 지급받습니다.',
    ...
    states: {
      ...
      wallet_unavailable: 'INJ Pass 지갑으로 로그인하세요.',
  ...
  ja: {
    ...
    subtitle: '新しい INJ Pass ウォレットには報酬が1回必ず当たります。',
    ...
    states: {
      ...
      wallet_unavailable: 'INJ Pass ウォレットでログインしてください。',
  ...
  'zh-Hans': {
    ...
    subtitle: '每个新注册的 INJ Pass 钱包必得一次奖励。',
    ...
    states: {
      ...
      wallet_unavailable: '请先登录 INJ Pass 钱包。',
  ...
  'zh-Hant': {
    ...
    subtitle: '每個新註冊的 INJ Pass 錢包必得一次獎勵。',
    ...
    states: {
      ...
      wallet_unavailable: '請先登入 INJ Pass 錢包。',
